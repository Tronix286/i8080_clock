...
static inline void i8080_execute(i8080* const c, uint8_t opcode) {
  ...
  case 0xC7: printf("0xC7 opcode!\r\n");
		i8080_call(c, 0x00); break; // RST 0
  case 0xCF: printf("0xCF opcode!\r\n");
		i8080_call(c, 0x08); break; // RST 1
  case 0xD7: printf("0xD7 opcode!\r\n");
		i8080_call(c, 0x10); break; // RST 2
  case 0xDF: printf("0xDF opcode!\r\n");
		i8080_call(c, 0x18); break; // RST 3
  case 0xE7: printf("0xE7 opcode!\r\n");
		i8080_call(c, 0x20); break; // RST 4
  case 0xEF: printf("0xEF opcode!\r\n");
		i8080_call(c, 0x28); break; // RST 5
  case 0xF7: printf("0xF7 opcode!\r\n");
		i8080_call(c, 0x30); break; // RST 6
  case 0xFF: printf("0xFF opcode!\r\n");
		i8080_call(c, 0x38); break; // RST 7
